...
export declare class GgufInsightsConfigurationResolver {
     ...
     */
    resolveAndScoreConfig({ targetGpuLayers, targetContextSize, embeddingContext, flashAttention, kvCacheKeyType, kvCacheValueType, swaFullCache, useMmap }?: {
     ...
     */
    scoreModelConfigurationCompatibility({ contextSize, embeddingContext, flashAttention, kvCacheKeyType, kvCacheValueType, swaFullCache, maximumFittedContextSizeMultiplier, maximumUnfitConfigurationResourceMultiplier, forceStrictContextSize, forceGpuLayers, useMmap }?: {
        contextSize?: number;
        embeddingContext?: boolean;
        flashAttention?: boolean;
        kvCacheKeyType?: GgmlType;
    ...
    resolveModelGpuLayers(gpuLayers?: LlamaModelOptions["gpuLayers"], { ignoreMemorySafetyChecks, getVramState, llamaVramPaddingSize, llamaGpu, llamaSupportsGpuOffloading, defaultContextFlashAttention, defaultContextKvCacheKeyType, defaultContextKvCacheValueType, defaultContextSwaFullCache, useMmap }?: {
     ...
     */
    resolveContextContextSize(contextSize: LlamaContextOptions["contextSize"], { modelGpuLayers, batchSize, modelTrainContextSize, flashAttention, kvCacheKeyType, kvCacheValueType, swaFullCache, getVramState, getRamState, getSwapState, llamaGpu, ignoreMemorySafetyChecks, isEmbeddingContext, sequences }: {
