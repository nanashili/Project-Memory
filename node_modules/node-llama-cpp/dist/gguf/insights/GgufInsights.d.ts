...
export declare class GgufInsights {
     ...
     */
    get dominantTensorType(): GgmlType | undefined;
     ...
     */
    estimateContextResourceRequirements({ contextSize, modelGpuLayers, batchSize, sequences, isEmbeddingContext, includeGraphOverhead, flashAttention, swaFullCache, kvCacheKeyType, kvCacheValueType }: {
        contextSize: number;
    ...
    private _estimateRecurrentStateMemorySizeInBytes;
    /**
     * @param ggufFileInfo
...
export declare function getDominantTensorType(tensorInfo: GgufTensorInfo[]): GgmlType | undefined;
