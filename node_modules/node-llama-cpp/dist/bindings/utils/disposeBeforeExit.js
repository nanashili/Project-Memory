let disposeRefs = new Set();
export function registerDisposeBeforeExit(ref) {
    if (disposeRefs.size === 0)
        process.once("beforeExit", onBeforeExit);
    disposeRefs.add(ref);
}
export function unregisterDisposeBeforeExit(ref) {
...
function isAsyncDisposable(target) {
...
//# sourceMappingURL=disposeBeforeExit.js.map