...
export class Llama {
    ...
    constructor({ bindings, bindingPath, extBackendsPath, logLevel, logger, buildType, cmakeOptions, llamaCppRelease, debug, tempDir, numa, buildGpu, maxThreads, vramOrchestrator, vramPadding, ramOrchestrator, ramPadding, swapOrchestrator, skipLlamaInit }) {
    ...
    /** @internal */
    static async _create({ bindings, bindingPath, extBackendsPath, buildType, buildMetadata, logLevel, logger, vramPadding, ramPadding, maxThreads, skipLlamaInit = false, debug, numa, tempDir }) {
        ...
        const resolvedTempDir = tempDir === false
            ? undefined
            : await getTempDir(typeof tempDir === "string"
                ? [tempDir]
                : tempDir);
