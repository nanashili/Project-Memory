...
export async function interactivelyAskForModel({ llama, modelsDirectory, allowLocalModels = true, downloadIntent = true, flashAttention = false, swaFullCache = false, useMmap, kvCacheKeyType, kvCacheValueType }) {
        ...
        while (true) {
            ...
            const selectedItem = await basicChooseFromListConsoleInteraction({
                ...
                renderItem(item, focused, rerender) {
                    return renderSelectionItem(item, focused, rerender, activeInteractionController.signal, llama, flashAttention, swaFullCache, useMmap, kvCacheKeyType, kvCacheValueType);
                },
                canFocusItem(item) {
...
function renderSelectionItem(item, focused, rerender, abortSignal, llama, flashAttention, swaFullCache, useMmap, kvCacheKeyType, kvCacheValueType) {
...
async function selectFileForModelRecommendation({ recommendedModelOption, llama, abortSignal, rerenderOption, flashAttention, swaFullCache, useMmap, kvCacheKeyType, kvCacheValueType }) {
    try {
