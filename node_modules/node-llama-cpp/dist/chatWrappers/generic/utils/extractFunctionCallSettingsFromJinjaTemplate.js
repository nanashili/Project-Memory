...
export function extractFunctionCallSettingsFromJinjaTemplate({ idsGenerator, renderTemplate, examineNonFirstFunctionCall = false }) {
...
export function detectNeedToWrapFunctionArgumentsWithMap({ idsGenerator, renderTemplate }) {
    ...
    const testChatHistoryWithParamsMap = [{
            type: "system",
            text: idsGenerator.generateId()
        }, {
            type: "user",
