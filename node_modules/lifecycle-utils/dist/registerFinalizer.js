const finalizationRegistry = new FinalizationRegistry(onFinalization);
 ...
 * ```
 */
export function registerFinalizer(target, finalizer) {
...
async function onFinalization([disposeTarget, token]) {
...
//# sourceMappingURL=registerFinalizer.js.map