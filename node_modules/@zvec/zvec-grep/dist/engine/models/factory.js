...
import { Qwen37TextEmbeddingModel, Qwen3VlEmbeddingModel, QwenTextEmbeddingV4Model, } from "./backends/qwen.js";
import { TransformersJsEmbeddingModel } from "./backends/transformers-js.js";
export function createEmbeddingModel(reference, options = {}) {
...
function createQwenEmbeddingModel(entry, options) {
    switch (entry.kind) {
        case "multimodal":
...
function unsupportedCatalogEntry(entry) {
