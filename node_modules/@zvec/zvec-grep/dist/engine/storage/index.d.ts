import type { CodeSymbolType, Entity, EntityFragment, FileInfo, WorkspaceIndexEmbeddingSchema } from "../types.js";
type StoredEntity = {
    entity: Entity;
    file: FileInfo;
};
...
export interface WorkspaceIndexStorage {
    ...
    listFiles(): FileInfo[];
    listEntitiesByFile(fileId: string, options?: {
        limit?: number;
        offset?: number;
    }): StoredEntity[];
    ...
    replaceFile(file: FileInfo, entries: readonly IndexedFragment[], diagnostics?: FileIndexDiagnostics): void;
...
export { deleteWorkspaceIndexStorage, hasWorkspaceIndexStorage, } from "./layout.js";
