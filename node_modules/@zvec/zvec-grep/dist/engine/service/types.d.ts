...
import type { CodeSymbolType, WorkspaceIndexPolicy, WorkspaceIndexStatus, WorkspaceIndexInfo, Content, EntityMetadata, IndexProgress, IndexResult, Range, RootPath, SearchPlanRoute, SearchHitTrace, SearchMatchedBy, TimingEntry } from "../types.js";
...
export type ZvecGrepWriterContext = (options: ZvecGrepContextOptions) => Promise<ZvecGrepContextResult>;
...
export type ZvecGrepContextCoverage = "ranked_sample" | "rg_exhaustive" | "rg_truncated";
