...
export function vectorContentForFragment(fragment, embeddingContent = fragment.content, maxChars) {
    if (embeddingContent.kind !== "text") {
        return embeddingContent;
    }
    const metadata = vectorMetadataText(fragment.metadata, metadataBudget(maxChars));
...
export function chunkOptionsForMetadata(options, metadata) {
...
export function fitTextToChars(value, maxChars) {
...
function vectorMetadataText(metadata, maxChars) {
    if (!metadata) {
        return "";
    }
...
//# sourceMappingURL=vector-content.js.map