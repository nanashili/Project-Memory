...
export type SkippedFileReason = "empty" | "too_large" | "unsupported" | "binary";
...
export type Range = FileRange | TextRange | ByteRange | PageRange | PageTextRange | PageRegionRange;
export type CodeSymbolType = "module" | "class" | "interface" | "function" | "value" | "alias";
export type CodeEntityModifier = "exported" | "async" | "static" | "public" | "private" | "protected" | "internal";
...
export declare const CURRENT_INDEX_VERSION = 1;
